...
urlpatterns = [
    ...
    # User URLs
    path('user/data/', getData, name='get_user_data'),
    ...
    # Truck URLs
    path('truck/data/', getData, name='get_truck_data'),
    ...
    # Trailer URLs
    path('trailer/data/', getData, name='get_trailer_data'),
    ...
    # Log URLs
    path('log/data/', getData, name='get_log_data'),
